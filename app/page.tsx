...
export default function HomePage() {
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] p-8">
        ...
        <DialogFooter className="gap-2 sm:gap-0">
          ...
          <Button onClick={handleCreateCV} disabled={!newCVTitle.trim()} className="h-12 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold shadow-md">
  ...
  const Logo = ({ className = "" }) => (
    <div className={`flex items-center gap-3 ${className}`}>
      <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-500 p-2.5 rounded-2xl shadow-lg shadow-blue-500/20">
        <FileBadge2 className="h-6 w-6 text-white" />
      </div>
      <span className="text-2xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-blue-800 to-gray-900">
        CVim
      </span>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 h-full w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] opacity-10"></div> {/* Opsiyonel: Hafif bir noise/grid dokusu */}
      </div>
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
                <CreateCVDialog 
                    triggerBtn={
                        <Button size="sm" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold shadow-md shadow-blue-500/20 transition-all hover:-translate-y-0.5">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left relative z-10">
              <Badge variant="secondary" className="mb-8 px-4 py-2 text-sm font-semibold bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 border border-blue-100 rounded-full shadow-sm inline-flex items-center">
              ...
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 tracking-tight mb-8 leading-tight">
                ...
                <span className="relative whitespace-nowrap">
                  <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">CVim</span>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-5">
                <CreateCVDialog 
                    triggerBtn={
                        <Button size="lg" className="h-14 px-10 text-lg bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-bold shadow-xl shadow-blue-600/30 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-600/40 transition-all group rounded-full">
                            <Rocket className="mr-2 h-6 w-6 group-hover:animate-bounce" />
                            Ücretsiz Başla
                        </Button>
                    }
                />
                 <Button size="lg" variant="outline" className="h-14 px-8 text-lg border-2 border-gray-300 text-gray-700 font-semibold hover:text-blue-700 hover:bg-blue-50 hover:border-blue-300 rounded-full transition-all">
                    Örnekleri İncele
                </Button>
              </div>
            </div>
            ...
            <div className="hidden lg:block relative z-10 perspective-1000">
              <div className="relative w-full h-[500px] bg-gradient-to-tr from-blue-100 to-indigo-50 rounded-[2rem] border-4 border-white/80 shadow-2xl shadow-blue-900/10 transform rotate-y-[-12deg] rotate-x-[5deg] hover:rotate-y-[0deg] hover:rotate-x-[0deg] transition-all duration-700 ease-out p-6 overflow-hidden">
